...
function doc_register_post_type() {

	$singular = __( 'Document Builder' );
	$plural = __( 'Document Builders' );
  ...
  //Create the post type using the above two variables.
	register_post_type( 'doc_builder', $args);
}
add_action( 'init', 'doc_register_post_type' );


function doc_register_taxonomy() {
	...
	register_taxonomy( strtolower( $singular ), 'doc_builder', $args );

}

add_action( 'init', 'doc_register_taxonomy' );
